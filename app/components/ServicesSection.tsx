        ...
        <div style={{
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              ...
              {/* ── Full-card dark tint (handles white/light photos) ── */}
              <div style={{
                position: "absolute",
                inset: 0,
              ...
              <div style={{
                position: "absolute",
                inset: 0,
                background: "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.1) 40%, rgba(0,0,0,0.82) 100%)",
                zIndex: 2,
              }} />

              {/* ── Number + Tag ── (top of card) */}
              <div style={{
                position: "absolute",
                top: 28,
                left: 28,
              ...
              {/* ── Text Content ── (bottom of card, on gradient) */}
              <div style={{
                position: "relative",
                zIndex: 3,
                padding: "28px",
